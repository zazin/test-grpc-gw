...
func request_Location_FindCountry_0(ctx context.Context, marshaler runtime.Marshaler, client LocationClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty
	var metadata runtime.ServerMetadata

	msg, err := client.FindCountry(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Location_FindCountry_0(ctx context.Context, marshaler runtime.Marshaler, server LocationServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty
	var metadata runtime.ServerMetadata

	msg, err := server.FindCountry(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterLocationHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LocationServer) error {
	...
	mux.Handle("GET", pattern_Location_FindCountry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/location.Location/FindCountry", runtime.WithHTTPPathPattern("/v1/location"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Location_FindCountry_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Location_FindCountry_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterLocationHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LocationClient) error {
	...
	mux.Handle("GET", pattern_Location_FindCountry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/location.Location/FindCountry", runtime.WithHTTPPathPattern("/v1/location"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Location_FindCountry_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Location_FindCountry_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "location"}, ""))
)

var (
	forward_Location_FindCountry_0 = runtime.ForwardResponseMessage
)
